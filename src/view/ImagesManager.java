 ...
 * @author rafa0
 */
public class ImagesManager extends javax.swing.JDialog {
    ...
    public ImagesManager(UI parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
    ...
    public ImagesManager(UI parent, boolean modal, String idSuspect) {
        super(parent, modal);
        this.parent = parent;
        photos = new Images[NPHOTOS];
        initComponents();
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        DialogChooser y = new DialogChooser(this, true);
